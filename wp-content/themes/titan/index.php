...
?>
	...
	<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		<div class="post-header">
			<div class="date"><?php the_time(__ ( 'M j', 'titan')); ?> <span><?php the_time( 'y' ); ?></span> <span class="category">in <?php the_category(',') ?></span></div>
		...
		<div class="entry clear">
			...
			<?php
			    if (in_category("London Burritos")) {
			        echo "<p class='cta'>But how does it rank in my list of <a href='http://www.ross-eats.co.uk/london%E2%80%99s-best-burrito/'>London's best burrito</a>?</p>";
			    }
			?>
