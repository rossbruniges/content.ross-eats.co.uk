...
function titan_custom_comment($comment, $args, $depth) {
	$GLOBALS['comment'] = $comment;
	?>
	<li <?php comment_class(); ?> id="comment-<?php comment_ID(); ?>" >
		<div class="c-grav"><?php echo get_avatar( $comment, '40' ); ?></div>
		<div class="c-body">
			<div class="c-head">
			...
			<?php endif; ?>
			<?php comment_text(); ?>
			<?php comment_type( ( '' ), __( 'Trackback', 'titan' ), __( 'Pingback', 'titan' ) ); ?>
			<div class="reply">
...
function titan_list_pings($comment, $args, $depth) {
	$GLOBALS['comment'] = $comment;
	?>
